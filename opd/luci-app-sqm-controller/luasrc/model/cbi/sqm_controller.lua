...
policy_mode:value("auto", translate("智能自动"))
policy_mode:value("balanced", translate("均衡模式"))
policy_mode:value("gaming", translate("游戏模式"))
policy_mode:value("live", translate("直播模式"))
policy_mode:value("meeting", translate("会议模式"))
policy_mode:value("download", translate("下载模式"))
policy_mode.default = "auto"
policy_mode.rmempty = false
policy_mode.description = translate("这里是用户场景模式。直播、会议、下载会映射到现有流媒体、游戏、批量队列，不新增 tc 队列。")
...
ping_host.description = '<div style="margin-top:-20px;">' .. translate("实时监控的 ping 探测目标。国内建议 223.5.5.5 或 114.114.114.114，国外可用 8.8.8.8。") .. '</div>'
